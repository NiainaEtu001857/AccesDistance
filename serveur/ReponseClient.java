...
public class ReponseClient extends Thread {
    ...
    public ReponseClient(ServerSocket serverSocket, Socket socket, InputStream input, DataOutputStream dout) {
        this.serverSocket = serverSocket;
        this.socket = socket;
        System.out.println(this.socket + "777777777777777777777");
        this.input = input;
        this.dout = dout;
        start();
    }
